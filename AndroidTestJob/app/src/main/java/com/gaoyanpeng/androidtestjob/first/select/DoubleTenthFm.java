 ...
 */
public class DoubleTenthFm extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fm_tenrth,container,false);
        return view;
    }
    ...
    private void initView() {
        mListView = (ListView) getView().findViewById(R.id.dou_ls);
